...
public class TestMediumActivity extends AppCompatActivity {
    TextView textScore;
    TextView TextTime;
    TextView textHeart;
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (userHeart <= 0)
                {
                    ...
                    Intent intent = new Intent(TestMediumActivity.this, Result.class);
    ...
    public void gameContinue() {
        ...
        //generate random numbers
        num1 = rd.nextInt(100-30) + 30;
        num2 = rd.nextInt(100-30) + 30;
        ...
        if (actionTitle.equals("Addition")) {
            ...
            boolean reroll = true;
            while (reroll) {
                num3 = rd.nextInt(50-10) + 10;
                num4 = rd.nextInt(50-10) + 10;
                //generate answer for question and sets the text for the question in textview
