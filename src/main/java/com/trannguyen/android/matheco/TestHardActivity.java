...
public class TestHardActivity extends AppCompatActivity {
    TextView textScore;
    TextView TextTime;
    TextView textHeart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //if run out of lives, open up the result and display user results
                if (userHeart <= 0)
                {
                    Toast.makeText(getApplicationContext(),R.string.game_over, Toast.LENGTH_LONG).show();
                    ok.setEnabled(false);
                    next.setEnabled(false);
                    Intent intent = new Intent(TestHardActivity.this, Result.class);
    ...
    public void gameContinue() {
        ...
        //generate random numbers
        num1 = rd.nextInt(1000-100) + 100;
        num2 = rd.nextInt(900-100) + 100;
        ...
        if (actionTitle.equals("Addition")) {
            ...
            boolean reroll = true;
            while (reroll) {
                num3 = rd.nextInt(450-100) + 100;
                num4 = rd.nextInt(200-50) + 50;
                //generate answer for question and sets the text for the question in textview
                if ( num3 % num4 == 0) {
